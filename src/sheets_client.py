...
E: Посилання (URL) | F: Match Score (%) | G: Короткий аналіз |
H: Рекомендоване CV | I: Пріоритет | J: CANVA | K: EN | L: На адаптацію
(M: Виконано, N: Feedback — керуються вручну, код туди не пише)
...
def append_rows(spreadsheet_id: str, worksheet_name: str, rows: list) -> None:
    """
    rows: list[list] — вже у порядку колонок A-L, і вже відсортовані за
